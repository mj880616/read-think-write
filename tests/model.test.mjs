...
assert.match(stylesSource,/--header-top:calc\(-20px - var\(--header-row1\)\);--header-h:[^}]+\}\s*\.topbar\{top:var\(--header-top\)\}\s*html\{scroll-padding-top:calc\(var\(--header-h\) \+ 12px\)\}/,'mobile header covers content with the menu row only, and scroll targets clear it');
